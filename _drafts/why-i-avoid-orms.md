...
I already have some improvements in the backlog:
- create documentation
- add more functions on the SQL builder (for either MySQL or PostgreSQL)
- create new helper packages (one with a HikariCP connection pool pre-configured and completely customizable)

What else do you propose? Would you like to use it?

Please let me know :) <br /><script type="IN/Share" data-url="{{site.url}}{{page.url}}"></script> this article on LinkedIn and tag me if you found it interesting.